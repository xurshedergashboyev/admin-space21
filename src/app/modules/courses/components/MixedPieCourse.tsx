    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 py-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Students by classes</span>
          <span className='text-muted fw-bold fs-7'>Total number of students by classes in August</span>
        </h3>
...
const chartOptions = (chartColor: string, chartHeight: string): ApexOptions => {
  ...
  return {
    series: [78, 45, 12, 15],
    labels: ['English 01', 'English 02', 'English 03', 'IELTS'],
    chart: {
      fontFamily: 'inherit',
      height: chartHeight,
      type: 'donut',
