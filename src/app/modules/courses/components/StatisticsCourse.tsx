        ...
        <div className='card-rounded bg-white mt-n10 position-relative card-px py-15'>
          ...
          <div className='row g-0 mb-7'>
            ...
            <div className='col mx-5'>
              <div className='fs-6 text-gray-400'>Total Classes</div>
              <div className='fs-2 fw-bolder text-gray-800'>3</div>
            </div>
            {/* end::Col  */}
            ...
            <div className='col mx-5'>
              ...
              <div className='fs-2 fw-bolder text-gray-800'>2</div>
            </div>
            {/* end::Col  */}
          </div>
          {/* end::Row  */}
