    ...
    <>
      ...
      >
        ...
        <div className='card-header border-0'>
          <div className='card-title m-0'>
            <div className='symbol symbol-30px w-30px bg-light'>
              {/*<img src={toAbsoluteUrl('')} alt='card2' className='p-3' />*/}
            </div>
          </div>
          <div className='card-toolbar'>
            <span className={`badge badge-light-primary fw-bolder`}>fsdaf</span>
        ...
        <div className='card-body px-9 pt-0'>
          <div className='fs-5 fw-bolder text-dark'>Hello</div>
          <p className='text-gray-400 fw-bold fs-7 mt-1 mb-7'>Lorem ipsum dolor sit amet.</p>
          ...
          >
            <div className={`bg-primary rounded h-4px`} role='progressbar' style={{width: `54%`}} />
          </div>
          {/*<TaskUsers users={users} />*/}
        </div>
      </div>
