        ...
        <form ref={formRef} id='kt_inbox_compose_form' onSubmit={() => console.log('submit')}>
          ...
          <div className='d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-top'>
            ...
            <div className='d-flex align-items-center me-3'>
              ...
              >
                <KTSVG className='svg-icon-1' path='/media/icons/duotone/Files/Cloud-upload.svg' />
              </a>
              <a href='#' className='btn btn-icon btn-active-light-primary'>
                <KTSVG className='svg-icon-1' path='/media/icons/duotone/Map/Marker1.svg' />
              </a>
              {/*end::Other*/}
            </div>
            {/*end::Actions*/}
            ...
            <div className='d-flex align-items-center'>
              <button
                ...
                title='More actions'
              >
                <KTSVG className='svg-icon-1' path='/media/icons/duotone/General/Settings-2.svg' />
              </button>
            </div>
            {/*end::Toolbar*/}
          </div>
