      ...
      <div className={`card-body ${innerPadding}`}>
        ...
        <div className='mb-10'>
          ...
          <div className='row' data-kt-control='toggle-buttons'>
            ...
            >
              <KTSVG path='/media/icons/duotone/Files/Media.svg' className='svg-icon-2x me-1' />
            ...
            >
              <KTSVG path='/media/icons/duotone/Devices/LTE2.svg' className='svg-icon-2x me-1' />
            ...
            >
              <KTSVG path='/media/icons/duotone/Shopping/Cart3.svg' className='svg-icon-2x me-1' />
            ...
            >
              <KTSVG path='/media/icons/duotone/Media/Equalizer.svg' className='svg-icon-2x me-1' />
